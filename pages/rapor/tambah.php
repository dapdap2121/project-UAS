...
<?php
$namasekolah = "SMAN 16 SURABAYA";
$alamatsekolah = "JL.Prapen Surabaya";
...
/*\if (isset($_POST["submit"])) {
    ...
    //query insert
    for ($i = 0; $i < $count; $i++) { }
    $sqlmapel = "INSERT INTO `tbl_nilai` (`id`, `nama`, `nisn`, `nama_kelas`, `id_semester`, `tahun_ajar`, `nama_mapel`, `nilai_umum`, 
    `nilai_total`, `nilai_huruf`) VALUES (NULL, '$namasiswa', '$nisn', '$kelas', '$semester', '$tahun', '$mapel', '$nilai', '', '$huruf')";
...
<div class="card">
    <div class="card-body bg-light">
        <h6 class="text-danger font-weight-bold text-center">Perhatikan : Input Nilai ini hanya satu kali, tidak dapat di edit kembali, 
            Mohon cek nilai dengan benar!</h6>
    </div>
                    ...
                    <table class="table table-light " id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tr>
                            ...
                            while ($datamapel = mysqli_fetch_assoc($sql_mapel)) :
                                ...
                                ?>
                                <input type="hidden" name="nama_guru" value="<?php echo $datamapel["nama_guru"] ?>">
                                <td>
                                    <input type="text" name="nama_mapel[]" id="nama_mapel[]" value="  <?php echo $mapel ?>" 
