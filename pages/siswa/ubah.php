...
if (isset($_POST["submit"])) {
    ...
    $ubah = "UPDATE `tbl_siswa` SET `nis` = '$nis', `nisn` = '$nisn', `nama` = '$nama', `jk` = '$jk', `tmp_lahir` = '$tmplahir', 
    `tgl_lahir` = '$tgllhr', `agama` = '$agama', `alamat` = '$alamat', `namaayah` = '$nmayah', `namaibu` = '$nmibu', 
    `kerjaayah` = '$krjayah', `kerjaibu` = '$krjibu' WHERE `tbl_siswa`.`id` = $id;";
