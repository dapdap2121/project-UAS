...
if (isset($_POST["submit"])) {
    ...
    $tambah = "INSERT INTO `tbl_siswa` (`id`, `nis`, `nisn`, `nama`, `jk`, `tmp_lahir`, `tgl_lahir`, `agama`, `alamat`, `namaayah`, 
    `namaibu`, `kerjaayah`, `kerjaibu`, `nama_kelas`) VALUES (NULL, '$nis', '$nisn', '$nama', '$jk', '$tmplahir', '$tgllhr', '$agama', 
    '$alamat', '$nmayah', '$nmibu', '$krjayah', '$krjibu', '$nmkelas')";
