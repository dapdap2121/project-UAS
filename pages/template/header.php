                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePage" aria-expanded="true" aria-controls="collapsePage">
                    ...
                    <div id="collapsePage" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="../rapor"> <i class="fa fas fa-book-open fa-1x"></i> Raport Kelas 10</a>
                            <a class="collapse-item" href="../rapor/index2.php"> <i class="fa fas fa-book-open fa-1x"></i> Raport Kelas 11</a>
                            <a class="collapse-item" href="../rapor/index3.php"> <i class="fa fas fa-book-open fa-1x"></i> Raport Kelas 12</a>
                        </div>
                    </div>
            </li>
            <!--Nav Item - Grafik nilai -->
            <li class="nav-item">
                <a class="nav-link" href="../chart/chart.php">
