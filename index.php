...
session_start();
if ($_SESSION) { "<script>
document.location.href= '../../informasi/index.php';
    </script>";
}
?>
<!DOCTYPE html>
...
<body class="bg-gradient-primary; opacity: 0.5;" style="background-size: cover; background-repeat: no-repeat; background-image: url(sman16.jpg) ; ">
                            ...
                            <div class="col-lg-12" >
                                <div class="p-5" >
                                    <div class="text-center">
                                        <h1 class="h4 text-dark-900 mb-4">Login E-Raport</h1>
                                    </div>
                                    <?php
                                    if (isset($_POST['login'])) {
                                        ...
                                        if (mysqli_num_rows($query) == 0) {
                                            echo '<div class="alert alert-danger">MaafLogin Salah.</div>';
                                        } else {
                                            ...
                                            if ($row['level'] == 1 && $level == 1) {
                                                ...
                                                header("Location: pages/rapor/indexwk.php");
